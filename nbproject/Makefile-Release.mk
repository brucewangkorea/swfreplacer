...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-MacOSX/swfreplacer

dist/Release/GNU-MacOSX/swfreplacer: ${OBJECTFILES}
...
${OBJECTDIR}/DefineText.o: nbproject/Makefile-${CND_CONF}.mk DefineText.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineText.o DefineText.cpp

${OBJECTDIR}/Exports.o: nbproject/Makefile-${CND_CONF}.mk Exports.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Exports.o Exports.cpp

${OBJECTDIR}/DefineFont2.o: nbproject/Makefile-${CND_CONF}.mk DefineFont2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineFont2.o DefineFont2.cpp

${OBJECTDIR}/DefineFont.o: nbproject/Makefile-${CND_CONF}.mk DefineFont.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineFont.o DefineFont.cpp
...
${OBJECTDIR}/DefineEditText.o: nbproject/Makefile-${CND_CONF}.mk DefineEditText.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineEditText.o DefineEditText.cpp
...
${OBJECTDIR}/PlaceObject2.o: nbproject/Makefile-${CND_CONF}.mk PlaceObject2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PlaceObject2.o PlaceObject2.cpp

${OBJECTDIR}/Tag.o: nbproject/Makefile-${CND_CONF}.mk Tag.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Tag.o Tag.cpp

${OBJECTDIR}/DefineButton2.o: nbproject/Makefile-${CND_CONF}.mk DefineButton2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineButton2.o DefineButton2.cpp

${OBJECTDIR}/TagWithCharacterID.o: nbproject/Makefile-${CND_CONF}.mk TagWithCharacterID.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TagWithCharacterID.o TagWithCharacterID.cpp

${OBJECTDIR}/DefineShape.o: nbproject/Makefile-${CND_CONF}.mk DefineShape.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineShape.o DefineShape.cpp

${OBJECTDIR}/SWFReader.o: nbproject/Makefile-${CND_CONF}.mk SWFReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SWFReader.o SWFReader.cpp
...
${OBJECTDIR}/DefineJPEG2.o: nbproject/Makefile-${CND_CONF}.mk DefineJPEG2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineJPEG2.o DefineJPEG2.cpp

${OBJECTDIR}/DefineSprite.o: nbproject/Makefile-${CND_CONF}.mk DefineSprite.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DefineSprite.o DefineSprite.cpp

${OBJECTDIR}/TagInstance.o: nbproject/Makefile-${CND_CONF}.mk TagInstance.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TagInstance.o TagInstance.cpp

${OBJECTDIR}/SWFWriter.o: nbproject/Makefile-${CND_CONF}.mk SWFWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SWFWriter.o SWFWriter.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-MacOSX/swfreplacer
